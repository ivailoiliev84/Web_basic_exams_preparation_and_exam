# Generated by Django 4.0.2 on 2022-02-27 07:43

import django.core.validators
from django.db import migrations, models
import exam.main_app.validators
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=15, validators=[django.core.validators.MinLengthValidator(2), exam.main_app.validators.validator_only_letters_numbers_and_underscore])),
